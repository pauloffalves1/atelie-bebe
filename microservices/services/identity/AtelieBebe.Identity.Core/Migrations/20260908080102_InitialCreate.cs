        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AddressStreet = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
                    AddressNumber = table.Column<string>(type: "TEXT", maxLength: 20, nullable: true),
                    AddressComplement = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
                    AddressNeighborhood = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    AddressCity = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    AddressState = table.Column<string>(type: "TEXT", maxLength: 2, nullable: true),
                    AddressZipCode = table.Column<string>(type: "TEXT", maxLength: 9, nullable: true)
                },
                constraints: table =>
                {
