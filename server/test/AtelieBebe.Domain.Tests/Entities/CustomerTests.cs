...
public class CustomerTests
{
    ...
    {
        Assert.Throws<DomainException>(() => Customer.Register(" ", CustomerEmail, "hash", null));
    }

    [Fact]
    public void Register_WithEmptyPasswordHash_Throws()
    {
        Assert.Throws<DomainException>(() => Customer.Register("Maria Silva", CustomerEmail, "", null));
    }
    ...
    {
        var customer = Customer.Register("Maria Silva", CustomerEmail, "hashed-password", null);
    ...
    {
        var customer = Customer.Register("Maria Silva", CustomerEmail, "old-hash", null);
